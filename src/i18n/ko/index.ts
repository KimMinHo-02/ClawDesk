export const ko = {
  ...
  automations: {
    ...
    loading: "불러오는 중...",
    noJobs: "관리할 automation job이 없습니다.",
    hint: "예약/트리거 작업(job)을 관리합니다. 실제 실행은 OpenClaw 게이트웨이가 담당합니다.",
    manualRunNote: "수동 실행(run)은 이 버전에서 제공하지 않습니다.",
    savedNote: "변경 후 실제 상태를 재조회했습니다.",
    ...
    scheduleKindAt: "한 번 (at)",
    scheduleKindEvery: "반복 (every)",
    scheduleKindCron: "크론 (cron)",
    scheduleKindUnknown: "미확인",
    everySuffixMin: "분마다",
    everySuffixHour: "시간마다",
    everySuffixDay: "일마다",
    wakeNow: "즉시 (now)",
    wakeNextHeartbeat: "다음 하트비트 (next-heartbeat)",
    ...
    editTitle: "Job 수정",
    nameLabel: "이름",
    nameHint: "1–128자 (control character 불가)",
    scheduleLabel: "스케줄",
    scheduleKindLabel: "스케줄 타입",
    scheduleValueLabel: "스케줄 값",
    scheduleValueHintAt: "로컬(현지) 시각으로 선택하면 UTC로 변환되어 전송됩니다",
    scheduleValueHintEvery: "1 이상의 숫자 (10 = 10분/시간/일)",
    scheduleValueHintCron: "5 또는 6 필드 (예: 0 9 * * 1)",
    scheduleUnitLabel: "단위",
    everyUnitMin: "분",
    everyUnitHour: "시간",
    everyUnitDay: "일",
    scheduleTzLabel: "타임존 (cron 전용)",
    scheduleTzHint: "IANA 타임존 (예: Asia/Seoul) — 비워 두면 호스트(로컬) 타임존 기준",
    payloadLabel: "내용",
    payloadKindLabel: "내용 타입",
    textLabel: "텍스트",
    textHint: "1–8000자",
    wakeLabel: "Wake (리마인더 전용)",
    kindChangeNote: "내용 타입(리마인더/작업)을 바꾸려면 job을 삭제한 뒤 다시 생성해야 합니다.",
    create: "추가",
    creating: "추가 중...",
    save: "저장",
    saving: "저장 중...",
    ...
    delete: "삭제",
    deleting: "삭제 중...",
    deleteConfirm: "이 automation job을 삭제할까요?",
    disableConfirm: "이 automation job을 비활성화(무효화)할까요?",

    // Frontend pre-validation messages (S2 UX; the backend re-validates)
    nameInvalid: "이름은 1–128자여야 합니다 (control character 불가).",
    scheduleInvalidAt: "날짜/시간을 선택해 주세요 (로컬 시각 → UTC 변환).",
    scheduleInvalidEvery: "1 이상의 숫자를 입력해 주세요 (단위는 옆에서 선택).",
    scheduleInvalidCron: "5 또는 6개 필드로 입력해 주세요 (예: 0 9 * * 1).",
    scheduleInvalidTz: "IANA 타임존 형식이 올바르지 않습니다 (예: Asia/Seoul).",
    payloadInvalid: "텍스트는 1–8000자여야 합니다.",
    wakeInvalid: "Wake 값이 올바르지 않습니다. (now / next-heartbeat)",

    errors: {
      "automation-id-invalid": "job ID 형식이 올바르지 않습니다.",
      "automation-name-invalid":
        "job 이름이 올바르지 않습니다. (1–128자, control character 불가)",
      "automation-schedule-invalid":
        "스케줄 값이 올바르지 않습니다. 입력값을 확인해 주세요.",
      "automation-payload-invalid":
        "내용 값이 올바르지 않습니다. 입력값을 확인해 주세요.",
      "openclaw-automations-failed":
        "automation 작업을 처리하는 데 실패했습니다. 다시 시도해 주세요.",
      "openclaw-not-found": "OpenClaw를 찾을 수 없습니다. 먼저 OpenClaw를 설치해 주세요.",
      "process-timeout": "작업이 시간 내로 완료되지 않았습니다. 다시 시도해 주세요.",
      "process-failed": "작업 실행에 실패했습니다. 다시 시도해 주세요.",
      fallback: "오류가 발생했습니다. 다시 시도해 주세요.",
